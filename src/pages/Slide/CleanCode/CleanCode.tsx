...
function CleanCode() {
    ...
    function addActiveClass(event: KeyboardEvent) {
        if (event.key == 'ArrowRight' && firstSection.current) {
            firstSection.current.classList.add(styles.active);
        }
    }

    return (
        <>
            <div className={`${slideStyles.slide}`} id='1' data-testid="first-one" ref={firstSection}>
                ...
                <section className={slideStyles.wrapper} id='2'>
                    <div className={slideStyles.container}>
                ...
                <section className={slideStyles.wrapper} id='3'>
                    <div className={slideStyles.container}>
                ...
                <section className={slideStyles.wrapper} id='4'>
                    <div className={slideStyles.container}>
                ...
                <section className={slideStyles.wrapper} id='5'>
                    <div className={slideStyles.container}>
                ...
                <section className={slideStyles.wrapper} id='6'>
                    <div className={slideStyles.container}>
                ...
                <section className={slideStyles.wrapper} id='7'>
                    <div className={slideStyles.container}>
